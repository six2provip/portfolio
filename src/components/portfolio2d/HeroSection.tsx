...
export function HeroSection({ onSwitchTo3D, onOpenProjects, onOpenResume }: HeroSectionProps) {
  return (
            ...
            <div className="rounded-2xl border border-white/15 bg-[#0e1017] p-5 shadow-2xl font-mono text-xs space-y-4">
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-zinc-400 ml-1 font-bold">khang.os ~ telemetry</span>
                </div>
              ...
              <div className="space-y-2 text-zinc-300">
                <div className="flex justify-between">
                  <span className="text-zinc-500">OPERATING ARCHITECTURE:</span>
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-zinc-300">FPT POLYTECHNIC</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-zinc-500">GRADUATION:</span>
                  <span className="text-zinc-300">12/2023</span>
                </div>
                <div className="flex justify-between">
              ...
              <div className="border-t border-white/10 pt-3 space-y-1.5 text-[11px] text-zinc-400">
                ...
                <div className="text-sky-300 italic">
                  &ldquo;Building systems, products and digital experiences with clarity, restraint and purpose.&rdquo;
                </div>
              </div>
            </div>
          </div>
